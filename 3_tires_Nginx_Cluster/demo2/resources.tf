...
EOF
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "s3cmd get s3://${aws_s3_bucket.web_bucket.id}/website/noau.jpg .",
      "sudo cp /home/ec2-user/index.html /usr/share/nginx/html/index.html",
      "sudo cp /home/ec2-user/noau.jpg /usr/share/nginx/html/noau.jpg",
  ...
  tags {
    Name = "${var.environment_tag}-skunk-${count.index + 1}"
    BillingCode = "${var.billing_code_tag}"
    Environment = "${var.environment_tag}"
  }
